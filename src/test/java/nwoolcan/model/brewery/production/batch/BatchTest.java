...
public class BatchTest {
    ...
    public void init() {
        ...
        b2.setWaterMeasurement(new WaterMeasurementBuilder().addRegistration(ParameterFactory.create(ParameterTypeEnum.WATER_MEASUREMENT, 1).getValue(), WaterMeasurement.Element.CALCIUM)
                                                            .build().getValue());
